...
{
    public class TimeManiaModel : SorteioAbstract
    {
        ...
        public TimeManiaModel(SorteioDocument document) : base(document.Concurso, document.Data, document.Local, document.DezenasOrdemSorteio, document.Dezenas, document.Trevos)
        {
        }
    }
}
