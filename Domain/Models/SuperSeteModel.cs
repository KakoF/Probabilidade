...
namespace Domain.Models
{
    public class SuperSeteModel : LoteriaAbstract
    {
        ...
        public SuperSeteModel(LoteriaDocument document) : base(document.Concurso, document.Data, document.Local, document.DezenasOrdemSorteio, document.Dezenas, document.Trevos)
        {
        }
    }
}
