...
{
    public abstract class SorteioAbstract
    {
        ...
        protected SorteioAbstract(int concurso, string data, string local, IEnumerable<string> dezenasOrdemSorteio, IEnumerable<string> dezenas, IEnumerable<string> trevos)
        {
            Concurso = concurso;
            Data = data;
            Local = local;
